...
entity mac_array_requantized_tb is
end entity mac_array_requantized_tb;

architecture rtl of mac_array_requantized_tb is
    signal COMPUTE_EN, CLR_ACC, CLK: std_logic;
    signal X_IN: signed(7 downto 0);
    signal PARAMS: signed(31 downto 0);
    signal MAC_ARRAY_OUT: signed(31 downto 0);
begin
    my_mac_array: entity work.mac_array_requantized
    port map(
        CLK=> CLK,
        ...
        X_IN=> X_IN,
        PARAMS=> PARAMS,
        MAC_ARRAY_OUT_REQUANT=> MAC_ARRAY_OUT
    );
    clk_proc: process
    begin
        loop
